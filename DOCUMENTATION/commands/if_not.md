...
if_not item_count holding <comparator> <int> {}
if_not item_count off_holding <comparator> <int> {}
if_not item_durability <identifier> <comparator> <num> {}
if_not item_durability holding <comparator> <num> {}
if_not item_durability off_holding <comparator> <num> {}
if_not jumping {}
...
# if_not reference_entity <identifier> {}
# if_not item_count <identifier> <comparator> <int> {}
# if_not item_count (holding|off_holding) <comparator> <int> {}
# if_not item_durability <identifier> <comparator> <num> {}
# if_not item_durability (holding|off_holding) <comparator> <num> {}
