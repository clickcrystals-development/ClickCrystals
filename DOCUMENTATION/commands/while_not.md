...
while_not <num>? item_cooldown holding <comparator> <num> {}
while_not <num>? item_cooldown off_holding <comparator> <num> {}
while_not <num>? item_count <identifier> <comparator> <int> {}
while_not <num>? item_count holding <comparator> <int> {}
while_not <num>? item_count off_holding <comparator> <int> {}
while_not <num>? item_durability <identifier> <comparator> <num> {}
while_not <num>? item_durability holding <comparator> <num> {}
while_not <num>? item_durability off_holding <comparator> <num> {}
...
# while_not <num>? reference_entity <identifier> {}
# while_not <num>? item_count <identifier> <comparator> <int> {}
# while_not <num>? item_count (holding|off_holding) <comparator> <int> {}
# while_not <num>? item_durability <identifier> <comparator> <num> {}
# while_not <num>? item_durability (holding|off_holding) <comparator> <num> {}
# while_not <num>? item_cooldown <identifier> <comparator> <num> {}
# while_not <num>? item_cooldown (holding|off_holding) <comparator> <num> {}
