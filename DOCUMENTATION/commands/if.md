...
if hotbar_count <identifier> <comparator> <int> {}
...
if input_active use {}
if inventory_count <identifier> <comparator> <int> {}
if inventory_has <identifier> {}
if inventory_slot <int> <identifier> {}
if invisible {}
