...
public class PacketMapper {
    ...
    public static final Map<Class<? extends Packet<?>>, Info> C2S = new HashMap<>() {{
        ...
        this.put(ClientSettingsC2SPacket.class, new Info("clientSettings", "ClientSettingsC2SPacket"));
        ...
        this.put(CustomPayloadC2SPacket.class, new Info("customPayload", "CustomPayloadC2SPacket"));
        ...
        this.put(KeepAliveC2SPacket.class, new Info("keepAlive", "KeepAliveC2SPacket"));
        ...
        this.put(PlayPongC2SPacket.class, new Info("playPong", "PlayPongC2SPacket"));
        ...
        this.put(ResourcePackStatusC2SPacket.class, new Info("resourcePackStatus", "ResourcePackStatusC2SPacket"));
    ...
    public static final Map<Class<? extends Packet<?>>, Info> S2C = new HashMap<>() {{
        ...
        this.put(CustomPayloadS2CPacket.class, new Info("customPayload", "CustomPayloadS2CPacket"));
        ...
        this.put(DisconnectS2CPacket.class, new Info("disconnect", "DisconnectS2CPacket"));
        ...
        this.put(FeaturesS2CPacket.class, new Info("features", "FeaturesS2CPacket"));
        ...
        this.put(KeepAliveS2CPacket.class, new Info("keepAlive", "KeepAliveS2CPacket"));
        ...
        this.put(PlayerSpawnS2CPacket.class, new Info("playerSpawn", "PlayerSpawnS2CPacket"));
        this.put(PlayPingS2CPacket.class, new Info("playPing", "PlayPingS2CPacket"));
        ...
        this.put(ResourcePackSendS2CPacket.class, new Info("resourcePackSend", "ResourcePackSendS2CPacket"));
        ...
        this.put(ScoreboardPlayerUpdateS2CPacket.class, new Info("scoreboardPlayerUpdate", "ScoreboardPlayerUpdateS2CPacket"));
        ...
        this.put(SynchronizeTagsS2CPacket.class, new Info("synchronizeTags", "SynchronizeTagsS2CPacket"));
        ...
        this.put(UnlockRecipesS2CPacket.class, new Info("unlockRecipes", "UnlockRecipesS2CPacket"));
