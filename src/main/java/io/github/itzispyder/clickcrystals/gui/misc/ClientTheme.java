...
public final class ClientTheme {
    ...
    public static int primaryLight() {
        if (currentPrimary == DEFAULT_PRIMARY)
    ...
    /**
     * 50%-alpha version of {@link #primaryLight()} — replaces
     * {@link Shades#TRANS_GENERIC}.
     */
    ...
    /**
     * 50%-alpha version of {@link #primaryDim()} — replaces
     * {@link Shades#TRANS_GENERIC_LOW}.
     */
    ...
    /**
     * Keep {@link Shades} mutable accent fields and
     * {@link io.github.itzispyder.clickcrystals.gui.hud.Hud#DEFAULT_COLOR} in sync
