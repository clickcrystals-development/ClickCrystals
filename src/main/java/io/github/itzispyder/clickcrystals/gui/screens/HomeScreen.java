...
public class HomeScreen extends DefaultBase {
    ...
    protected void init() {
        ...
        DetailedButtonElement githubPage = new DetailedButtonElement(TexturesIdentifiers.HOLLOW_HORIZONTAL_WIDGET, modulesPage.x, modulesPage.y + modulesPage.height + pageGap, 100, 35, "Open Source Code", "", 0.8F);
        ...
        DetailedButtonElement modrinthPage = new DetailedButtonElement(TexturesIdentifiers.HOLLOW_HORIZONTAL_WIDGET, githubPage.x + githubPage.width + pageGap, githubPage.y, 100, 35, "Check for Updates!", "", 0.8F);
        ...
        DetailedButtonElement creditsPage = new DetailedButtonElement(TexturesIdentifiers.HOLLOW_HORIZONTAL_WIDGET, modrinthPage.x + modrinthPage.width + pageGap, githubPage.y, 100, 35, "Credits", "", 0.8F, button -> {
