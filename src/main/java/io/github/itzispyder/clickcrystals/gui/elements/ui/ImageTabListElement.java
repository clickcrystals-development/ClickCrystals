...
public class ImageTabListElement extends TabListElement<ImageElement> {
    ...
    protected void renderExtras(DrawContext context, int mouseX, int mouseY) {
        ...
        RenderUtils.drawHorizontalLine(context, selectionX + 2, y + height - 1, (int)sectionWidth, 2, 0xD03873A9);

        for (int i = 1; i < options.size(); i++) {
            RenderUtils.drawText(context, "§7|", x + (int)(sectionWidth * i), y + (int)(height * 0.5), 0.6F, false);
        }
    }
}
