...
public final  class TexturesIdentifiers {
    ...
    // gui
    public static final Identifier SCREEN_BANNER = new Identifier(modId, "textures/gui/screen_title_banner.png");
    ...
    public static final Identifier SEARCH = new Identifier(modId, "textures/gui/search.png");
    public static final Identifier HOME = new Identifier(modId, "textures/gui/home.png");

    // modules
    public static final Identifier MODULE_ON = new Identifier(modId, "textures/modules/module_on.png");
    public static final Identifier MODULE_OFF = new Identifier(modId, "textures/modules/module_off.png");
    public static final Identifier MODULE_EMPTY = new Identifier(modId, "textures/modules/module_empty.png");
