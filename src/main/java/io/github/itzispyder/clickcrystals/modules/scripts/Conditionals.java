...
public class Conditionals implements Global {
    ...
    public static final Conditional JUMPING = register("jumping", (ref, args, i) -> pair(true, PlayerUtils.valid() && mc.options.jumpKey.isPressed() && !mc.player.isTouchingWater(), i + 1));
